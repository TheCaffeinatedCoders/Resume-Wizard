...
<div class="w-full p-4">
    ...
    <div class="flex flex-row flex-wrap space-x-9">
        <div class="max-w-xs w-60 p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            <a href="/home/edit">
                <div class="ml-11 mt-6">
                    <img src={newDoc} width="100" >
